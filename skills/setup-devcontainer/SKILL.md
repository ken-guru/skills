...
- `.devcontainer/<tool>/post-create.sh` — generated by
  ...
  6-block template order (base identity setup, the identity banner, this tool's own install block,
  its yolo-alias block, and the SSH block pair) deterministically, chmod'ing the result +x:
