...
[Build a presentation with the guided workflow](../build-presentation/SKILL.md), or
use [Discover Presentation](../discover-presentation/SKILL.md) to start or revise the
brief.
