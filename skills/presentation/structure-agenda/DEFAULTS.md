# Defaults for Structure Agenda

## Narrative structures

Infer the most fitting structure from the topic and occasion in `DISCOVERY.json`. Present the inferred choice when proposing the agenda outline.
